...
class_call = chart
# The above code is used to define boject for the class chart
...
while x != 0:
    ...
    if x == 1:
        ...
        Enter_row = int(input('Enter Row number for booking - \n'))
        Enter_column = int(input('Enter Column number for booking - \n'))
